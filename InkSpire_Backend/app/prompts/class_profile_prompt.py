...
def get_class_profile_prompt() -> ChatPromptTemplate:
    ...
    return ChatPromptTemplate.from_messages([
        (
            ...
            "3) Class learner profile characteristics (use these ideas when writing the class paragraph):\n"
            "- The cohorts' prior knowledge and skills and what types of course content and scaffolds would be most suitable for them.\n"
            "- Major learning challenges and difficulties and possible ways to address these particular challenges.\n"
            "- Size of class and suitable discussion formats facilitaetd in scaffolds.\n\n"
            ...
            "      - \"class_paragraph\": one paragraph describing the class learner profile characteristics "
            "        (prior knowledge, major learning challenges, and class size) in an integrated narrative.\n"
