...
def get_focus_prompt():
    return ChatPromptTemplate.from_messages([
        (
            ...
            "4. Inquiry Practices and Strategies\n"
            "- Places where reasoning strategies or inquiry practices are demonstrated.\n"
            "- Places where the text shifts from describing knowledge → to validating or testing knowledge.\n\n"
        ...
        (
            ...
            "- If a numeric focus fragment count target is provided, return exactly that many focus_areas.\n\n"
