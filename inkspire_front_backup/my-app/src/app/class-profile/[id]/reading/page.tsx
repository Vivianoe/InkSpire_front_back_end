...
export default function ReadingUploadPage() {
  ...
  const resolvedCourseId = searchParams?.get('courseId') || MOCK_COURSE_ID;
  ...
  const handleStartScaffoldSelection = async () => {
    ...
    try {
      ...
      navParams.set('from', profileId || 'new');
        ...
        <div className={styles.header}>
          <div>
            ...
            <p className={styles.subtitle}>
              Upload readings for this class and choose which ones to scaffold.
            </p>
          </div>
